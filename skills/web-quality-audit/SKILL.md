...
## Deep-dive references (vendored siblings)

For a focused pass on one category, read the corresponding reference in this skill's
`references/` directory instead of re-deriving: [accessibility](references/accessibility.md) ·
[core-web-vitals](references/core-web-vitals.md) · [performance](references/performance.md) ·
[seo](references/seo.md) · [best-practices](references/best-practices.md). Each is the full
standalone skill from upstream (400-650 lines), folded in here to keep the skill list lean.
